...
<div class="container mt-5 py-2">
    @auth
        ...
        @endif
    @endauth
    <h1 class="text-center" style="color:black; font-weight:bold;">All Subjects from All Semesters</h1>
                        ...
                        @if ($semester->subjects->count() > 0)
                            <div class="table-responsive shadow-lg p-4 mb-5 bg-white rounded">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h2 style="color:black; font-weight:bold;">Subjects Overview</h2>
                                    @auth
                                    @if(Auth::user()->hasRole('Admin'))
                                    ...
                                    <tbody>
                                        @foreach ($semester->subjects as $subject)
                                            <tr style="cursor: pointer;"
                                                ...
                                                <td class="text-center" style="white-space: nowrap; width: 30%;">
                                                    {{ $subject->Subject_name }}
                                                </td>
                                                <td class="text-center" style="white-space: nowrap; width: 30%;">
                                                    {{ $subject->Subject_lecturer }}
                                                </td>
